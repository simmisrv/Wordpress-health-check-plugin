...
function cc_bmi_scripts() {
	wp_register_style( 'Health-calculator', plugins_url('/Health-calculator.css',__FILE__), NULL, '2.0.1'); 
	wp_enqueue_style( 'Health-calculator' );
    wp_enqueue_script( 'Health-calculator', plugins_url('/Health-calculator.js',__FILE__), array('jquery'), '2.0.1', true );
}
